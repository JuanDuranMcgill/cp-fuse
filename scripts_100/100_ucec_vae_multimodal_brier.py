...
#root_folder = '/Data/Juan/local_embeddings/TCGA-UCEC/clinical'
root_folder = '../local_embeddings/TCGA-UCEC/clinical'
...
df_blca = df[df['type'].str.contains("UCEC", na=False)]

# Load the Excel file with endpoints
#file_path = "/Data/Juan/HIV_TCGA.xls"
file_path = "HIV_TCGA.xls"
df_hiv_in= pd.read_excel(file_path, header=1)
df_hiv = df_hiv_in[df_hiv_in['Study'].str.contains("UCEC", na=False)]
...
def train_evaluate_wsi(params, train_loader, val_loader, save_dir):
    ...
    def create_stratification_plot(risks, times, events, save_path=os.path.join(save_dir, "p-solo-stratification-ucec.png")):
...
def train_evaluate_fold_clinical(params, train_loader, val_loader, categories, num_continuous, save_dir, device='cuda'):
    ...
    def create_clinical_stratification_plot(risks, times, events, save_path=os.path.join(save_dir, "c-solo-stratification-ucec.png")):
...
def train_evaluate_end_to_end_fusion_vae(
    ...
    def create_vae_stratification_plot(risks, times, events, save_path=os.path.join(save_dir, "vae-stratification-ucec.png")):
        """
...
def run_joint_experiment_standard_cv(clinical_data_yes_id, clinical_param_grid, embedding_dir, json_path, wsi_param_grid, model_type, cp_model, sr, filter_substring="DX1"):
    ...
    numeric_cols = [
        ...
        'patient.height',
        'patient.weight',
        'patient.total_pelv_lnr',
        'patient.pln_pos_light_micro',
        'patient.pln_pos_ihc',
        'patient.total_pelv_lnp',
        'patient.total_aor_lnr',
        'patient.aln_pos_light_micro',
        'patient.aln_pos_ihc',
        'patient.total_aor-lnp',
        'patient.pct_tumor_invasion',
        'HPV load'
    ...
    categorical_cols = [
        ...
        'patient.horm_ther',
        'patient.prior_tamoxifen_administered_usage_category',
        'patient.pregnancies',
        'patient.birth_control_pill_history_usage_category',
        'patient.hypertension',
        'patient.diabetes',
        'patient.colorectal_cancer',
        'patient.residual_tumor',
        'patient.menopause_status',
        'patient.surgical_approach',
        'patient.peritoneal_wash',
        'patient.stage_event.clinical_stage',
        'HPV.status',
        'patient.tumor_tissue_site_other'
    ]
    ...
    #orig_embeddings_dir = os.path.expanduser('/Data/Juan/local_embeddings/TCGA-UCEC-embeddings/')
    orig_embeddings_dir = os.path.abspath('../local_embeddings/TCGA-UCEC-embeddings/') 
...
if __name__ == "__main__":
    ...
    #embedding_dir = "/Data/Juan/local_embeddings/TCGA-UCEC-embeddings/"
    #json_path = "svs_patient_map_PFI_ucec.json"
    embedding_dir = '../local_embeddings/TCGA-UCEC-embeddings/'    
    json_path = "svs_patient_map_PFI_ucec.json"
