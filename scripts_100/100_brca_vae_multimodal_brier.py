...
def train_evaluate_wsi(params, train_loader, val_loader, save_dir):
    ...
    def create_stratification_plot(risks, times, events, save_path=os.path.join(save_dir, "p-solo-stratification-brca.png")):
...
def train_evaluate_fold_clinical(params, train_loader, val_loader, categories, num_continuous, save_dir, device='cuda'):
    ...
    def create_clinical_stratification_plot(risks, times, events, save_path=os.path.join(save_dir, "c-solo-stratification-brca.png")):
...
def train_evaluate_end_to_end_fusion_vae(
    ...
    def create_vae_stratification_plot(risks, times, events, save_path=os.path.join(save_dir, "vae-stratification-brca.png")):
        """
